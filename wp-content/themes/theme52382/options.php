...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '24px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#b6b3a6'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
							    'std' => array( 'size' => '60px', 'lineheight' => '60px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '40px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#15c1c6'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '15px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
							    'std' => array( 'size' => '50px', 'lineheight' => '50px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#15c1c6'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
							    'std' => array( 'size' => '30px', 'lineheight' => '30px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#bbbaba'));
