...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php foreach(array("Twitter", "Facebook", "Feed", "Flickr", "Linkedin", "Delicious", "Youtube", "Google+") as $network) : ?>
...
?>
	...
	<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
		...
		<p>
			<label for="<?php echo $this->get_field_id('youtube'); ?>"><?php _e('Youtube URL', CHERRY_PLUGIN_DOMAIN) ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('youtube_label'); ?>"><?php _e('Youtube label', CHERRY_PLUGIN_DOMAIN); ?>:</label>
