		...
		<ul class="comments-custom unstyled"><?php
			...
			<li class="comments-custom_li">
				...
				if($display_date != 'off') {
					...
					echo '<div class="meta_format">'.$title_date.'<time datetime="'.date('Y-m-d\TH:i:s', strtotime($comment_date.$comment_time)).'">'.$comment_date.'</time></div>';
				}?>
			<div class="clear"></div>
	...
	function form($instance) {
		...
		<p><label for="<?php echo $this->get_field_id('avatar_size'); ?>"><?php _e('Avatar size (px)', CHERRY_PLUGIN_DOMAIN).":"; ?>
			<select id="<?php echo $this->get_field_id('avatar_size'); ?>" name="<?php echo $this->get_field_name('avatar_size'); ?>" style="width:80px;" >
				...
				<option value="70" <?php echo ($avatar_size === '70' ? ' selected="selected"' : ''); ?>><?php echo "70x70"; ?></option>
				<option value="64" <?php echo ($avatar_size === '64' ? ' selected="selected"' : ''); ?>><?php echo "64x64"; ?></option>
				<option value="60" <?php echo ($avatar_size === '60' ? ' selected="selected"' : ''); ?>><?php echo "60x60"; ?></option>
